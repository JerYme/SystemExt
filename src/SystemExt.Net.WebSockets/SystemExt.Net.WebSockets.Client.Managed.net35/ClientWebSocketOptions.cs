...
namespace System.Net.WebSockets.Client
{
    public sealed class ClientWebSocketOptions
    {
        ...
        private TimeSpan _keepAliveInterval = TimeSpanExt.InfiniteTimeSpan;
        ...
        public TimeSpan KeepAliveInterval
        {
            ...
            {
                ThrowIfReadOnly();
                if (value != TimeSpanExt.InfiniteTimeSpan && value < TimeSpan.Zero)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), value,
                        SR.Format(SR.net_WebSockets_ArgumentOutOfRange_TooSmall,
                            TimeSpanExt.InfiniteTimeSpan.ToString()));
                }
