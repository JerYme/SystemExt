...
namespace System
{
    internal static class StringExtensions
    {
        ...
        internal static bool IsNullOrWhiteSpace(this string value) => string.IsNullOrEmpty(value) || Enumerable.Range(0, value.Length).All(i => char.IsWhiteSpace(value[i]));

        internal static string SubstringTrim(this string value, int startIndex) => SubstringTrim(value, startIndex, value.Length - startIndex);
