...
namespace System.Net.WebSockets.Client
{
    internal sealed class WebSocketHandle
    {
        ...
        public async Task ConnectAsyncCore(Uri uri, CancellationToken cancellationToken, Client.ClientWebSocketOptions options)
        {
        ...
        private static byte[] BuildRequestHeader(Uri uri, Client.ClientWebSocketOptions options, string secKey)
        {
        ...
        private async Task<string> ParseAndValidateConnectResponseAsync(
            Stream stream, Client.ClientWebSocketOptions options, string expectedSecWebSocketAccept, CancellationToken cancellationToken)
        {
